...
class Organisation(models.Model):
    ...
    billing_address_l2 = models.TextField(blank=True, null=True)
    ...
    billing_zipcode = models.CharField(max_length=50, blank=True, null=True)
    shipping_address = models.TextField(blank=True, null=True)
    shipping_address_l2 = models.TextField(blank=True, null=True)
    ...
    shipping_zipcode = models.CharField(max_length=50, blank=True, null=True)
    is_bill_ship_add_same = models.BooleanField(default=False)
